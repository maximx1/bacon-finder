...
class ShoplocalAPIParser extends APIParser {
  protected val stores = List(// Big stores should have the same lists in the region do only 1 at a time.
    StoreInfo("2624382", "890be739b05081c2", "Aldi", "1025 Wylie Drive, Bloomington, IL 61705-9341"),
    StoreInfo("2595133", "89eece5eb3aae72b", "Meijer", "301 Greenbriar Drive, Normal, IL 61761-6253"),
    StoreInfo("2596482", "e4d5e311cadb36cb", "Walgreens", "909 S Main st, Bloomington, IL 61701")//,
    //StoreInfo("2506446", "187973615c5c071a", "CVS", "210 North Center, Bloomington, IL 61701")
  )
